      ...
      <div className="space-y-6">
        ...
        >
          <div>
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2">
              <DataSourceStatus dataSource={ALERTS_DATA_SOURCE} />
        ...
        <div className="space-y-3">
          ...
          <p className="px-1 text-[11px] text-muted-foreground leading-relaxed">
            Alerts are generated by SKYSENSE&apos;s rule engine from simulated environmental data for demonstration
            purposes. ESP32 hardware is not connected; no readings shown here originate from a live device. Acknowledge
            and resolve actions are local to this session.
          </p>
        </div>
